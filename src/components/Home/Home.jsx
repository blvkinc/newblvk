...
function sketch(p) {
    ...
    let headerHeight = 85; // Replace with your actual header height
    let footerHeight = 85; // Replace with your actual footer height

p.setup = function () {
  let canvasHeight = window.innerHeight - headerHeight - footerHeight;
